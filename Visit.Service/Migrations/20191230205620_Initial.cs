        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationId = table.Column<string>(type: "varchar(6)", nullable: false),
                    toVisit = table.Column<ulong>(type: "bit(1)", nullable: false),
                    visited = table.Column<ulong>(type: "bit(1)", nullable: false),
                    specialCase = table.Column<string>(type: "varchar(20)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLocation", x => x.id);
                    table.ForeignKey(
                        name: "UserLocation_ibfk_2",
                        column: x => x.LocationId,
                        principalTable: "Location",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "UserLocation_ibfk_1",
                        column: x => x.userId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
